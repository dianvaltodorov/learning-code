...
namespace oop{
    ...
    public:
        ...
        void   operator() (unsigned start, unsigned len);  // Отразва вектора до парче с даденото начало и дължина
    ...
    protected: 
        ...
        void copy(const double* vals, unsigned size);   // Копира данните в НЕ ИНИЦИАЛИЗИРАН обект.
